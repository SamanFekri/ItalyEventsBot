...
const process = [AD_STATUS.INIT, AD_STATUS.ASK_TITLE, AD_STATUS.ASK_ENGLISH, AD_STATUS.ASK_REGION, AD_STATUS.ASK_PRICE, AD_STATUS.ASK_ADDRESS, AD_STATUS.ASK_MONTH, AD_STATUS.ASK_DAY, AD_STATUS.ASK_TICKET, AD_STATUS.ASK_DETAIL, AD_STATUS.ASK_PIC, AD_STATUS.ASK_CONFIRM];
const AD_CAT = {
    a_concert: {
        icon: '🎤',
        display: '🎤 کنسرت',
